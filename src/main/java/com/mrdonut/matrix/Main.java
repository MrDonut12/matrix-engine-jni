...
public class Main {
    ...
    public static Matrix readMatrix(BufferedReader br, int size) throws IOException {
        ...
        public static void menu(MatrixService matrixService) throws Exception {
            ...
            while (true) {
                ...
                switch (commandType) {
                    ...
                    case "add": {
                        Matrix outputMatrix = matrixService.matrixAddition(matrixA, matrixB);
                    ...
                    case "sub": {
                        Matrix outputMatrix = matrixService.matrixSubtraction(matrixA, matrixB);
                        System.out.println("Output:");
                        printMatrix(outputMatrix);
                        break;
                    }
                    ...
                    case "mul": {
                        Matrix outputMatrix = matrixService.matrixMultiplication(matrixA, matrixB);
                        System.out.println("Output:");
                        printMatrix(outputMatrix);
                        break;
                    }
                    ...
                    case "transpose": {
                        Matrix outputMatrixA = matrixService.transposeMatrix(matrixA);
                        Matrix outputMatrixB = matrixService.transposeMatrix(matrixB);
                        System.out.println("Output:");
